...
public class ResearchHelper {
    ...
    public static void makeResearch(String tag, String tab, String name, int Xpos, int Ypos, Object icon,ResearchStage[] stages,String[] parents, EnumResearchMeta... meta) {
		makeResearch(tag, tab, name, Xpos, Ypos, icon, stages, parents, null, meta);
	}

    public static void makeThaumaturgyResearch(String tag,String name, int Xpos, int Ypos,Object icon, ResearchStage[] stages, String[] parents, EnumResearchMeta... meta) {
        makeResearch(tag, "THAUMATURGY", name, Xpos, Ypos, icon, stages, parents, null, meta);
    }

    public static void makeThaumaturgyResearch(String tag,String name, int Xpos, int Ypos,Object icon, ResearchStage[] stages, String[] parents,ResearchAddendum[] add, EnumResearchMeta... meta) {
        makeResearch(tag, "THAUMATURGY", name, Xpos, Ypos, icon, stages, parents, add, meta);
    }
