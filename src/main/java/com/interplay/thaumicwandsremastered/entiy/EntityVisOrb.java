...
public class EntityVisOrb extends Entity {
    ...
    public void onUpdate() {
        ...
        if(this.onGround) {
            ...
            if(!state.getBlock().isAir(state, (IBlockAccess) this.world,
                    new BlockPos(posX, Objects.requireNonNull(this.getCollisionBoundingBox()).minY - 1, this.posZ)))
    ...
    public boolean handleWaterMovement() {
        return world.handleMaterialAcceleration(Objects.requireNonNull(this.getCollisionBoundingBox()), Material.WATER, this);
    }
