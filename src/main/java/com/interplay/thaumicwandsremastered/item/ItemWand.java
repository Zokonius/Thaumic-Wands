...
public class ItemWand extends ItemBase implements IWand {
    ...
    public IWandCap getCap(ItemStack stack) {
        if(stack.hasTagCompound()) {
            ...
            IWandCap cap = ThaumicWandsRemasteredAPI.getWandCap(s);
            return cap != null ? cap : TWR_Wands.capIron;
        }
        return TWR_Wands.capIron;
    }
    ...
    public IWandRod getRod(ItemStack stack) {
        if(stack.hasTagCompound()) {
            ...
            IWandRod rod = ThaumicWandsRemasteredAPI.getWandRod(s);
            return rod != null ? rod : TWR_Wands.rodWood;
        }
        return TWR_Wands.rodWood;
    }
