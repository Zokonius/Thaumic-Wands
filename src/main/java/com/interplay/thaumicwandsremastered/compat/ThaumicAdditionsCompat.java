...
public class ThaumicAdditionsCompat implements TWR_Compat.ICompat {
    ...
    public void initRecipes() {
        ...
        TWR_Recipes.addShapedArcaneRecipe("CAP_MITHRILLIUM.1", "CAP_MITHRILLIUM@1",new ItemStack(itemWandCap,1, 0), 100, crystals, "nnn","n n", 'n', "nuggetMithrillium");
        ...
        TWR_Recipes.addShapedArcaneRecipe("CAP_ADAMINITE.1", "CAP_ADAMINITE@1",new ItemStack(itemWandCap,1, 2), 150, crystals, "nnn","n n", 'n', "nuggetAdaminite");
        ...
        TWR_Recipes.addShapedArcaneRecipe("CAP_MITHMINITE.1", "CAP_MITHMINITE@1", new ItemStack(itemWandCap,1, 4), 200, crystals, "nnn","n n", 'n', "nuggetMithminite");
        ...
        TWR_Recipes.addInfusionRecipe("CAP_ADAMINITE.2", "CAP_ADAMINITE@1", new ItemStack(itemWandCap,1, 3), 8, new ItemStack(itemWandCap,1, 2), aspects, new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus));
        ...
        TWR_Recipes.addInfusionRecipe("CAP_MITHMINITE.2", "CAP_MITHMINITE@1", new ItemStack(itemWandCap,1, 5), 6, new ItemStack(itemWandCap,1, 4), aspects, primordialPearl, new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus));
        ...
        TWR_Recipes.addInfusionRecipe("ROD_ADAMINITEWOOD.1", "ROD_ADAMINITEWOOD@1", new ItemStack(itemWandRod), 8, new ItemStack(TWR_Items.itemWandRod, 1, 7), aspects, ingotAdaminite, ingotAdaminite, clothAdaminite, clothAdaminite, new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus), new ItemStack(ItemsTC.salisMundus));
    ...
    public void initResearch() {
        ...
        stages = new ResearchStage[] {
                new ResearchHelper.RSB()
                        ...
                        .setKnow(new ResearchStage.Knowledge(THEORY, ResearchCategories.getResearchCategory("THAUMADDITIONS"), 2), new ResearchStage.Knowledge(THEORY, ResearchCategories.getResearchCategory("THAUMATURGY"), 2))
                        .build(),
                new ResearchHelper.RSB()
                        .setText("research.CAP_MITHRILLIUM.stage.1")
                        .setRecipes(TWR_Recipes.recipes.get("CAP_MITHRILLIUM.1"), TWR_Recipes.recipes.get("CAP_MITHRILLIUM.2"))
                        .build()
        };
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_ADAMINITE.1"), TWR_Recipes.recipes.get("CAP_ADAMINITE.2"))
                        .build()
        };
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_MITHMINITE.1"), TWR_Recipes.recipes.get("CAP_MITHMINITE.2"))
                        .build()
        };
        ...
        stages = new ResearchStage[] {
                new ResearchHelper.RSB()
                        ...
                        .setRequiredCraft(GameRegistry.makeItemStack("thaumadditions:adaminite_ingot", 0, 1, null), new ItemStack(TWR_Items.itemWandRod, 1, 7))
                        .setKnow(new ResearchStage.Knowledge(THEORY, ResearchCategories.getResearchCategory("THAUMADDITIONS"), 2), new ResearchStage.Knowledge(THEORY, ResearchCategories.getResearchCategory("THAUMATURGY"), 2))
                        .build(),
                new ResearchHelper.RSB()
                        .setText("research.ROD_ADAMINITEWOOD.stage.1")
                        .setRecipes(TWR_Recipes.recipes.get("ROD_ADAMINITEWOOD.1"))
                        .build()
        };
