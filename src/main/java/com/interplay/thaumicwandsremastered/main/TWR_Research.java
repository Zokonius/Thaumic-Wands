...
import com.interplay.thaumicwandsremastered.util.CardConductance;
import com.interplay.thaumicwandsremastered.util.CardFocussing;
...
public class TWR_Research {

    public static ResearchCategory catThaumaturgy;
    //	public static final ResourceLocation iconVisorb = new ResourceLocation(ThaumicWandsRemastered.MODID, "textures/research/r_visorb.png");
    public static final ResourceLocation iconThaumaturgy = new ResourceLocation(ThaumicWandsRemastered.MODID,"textures/research/icon_thaumaturgy.png");
    public static final ResourceLocation backThaumaturgy = new ResourceLocation(ThaumicWandsRemastered.MODID,"textures/research/tab_thaumaturgy.jpg");
    ...
    public static Logger LOGGER = LogManager.getLogger(TWR_Research.class);
            ...
            new Thread(() -> {
                while(ResearchCategories.getResearchCategory("BASICS").research.containsKey("THAUMATURGY"))
                    try {
                        ...
                        LOGGER.error("An error has occurred when trying to setup commands for TWR", e);
                    }
    ...
    public static void init() {
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("BASETHAUMATURGY.1"),TWR_Recipes.recipes.get("BASETHAUMATURGY.2"))
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("PRIMALCHARM.1"))
                        .build()
        };
        parents = new String[] {"BASETHAUMATURGY", "UNLOCKAUROMANCY@2","METALLURGY@2"};
        ResearchHelper.makeThaumaturgyResearch("PRIMALCHARM", 0, -2, new ItemStack(TWR_Items.itemPrimalCharm), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_COPPER.1"))
                        .build()
        };
        parents = new String[] {"BASETHAUMATURGY"};
        ResearchHelper.makeThaumaturgyResearch("CAP_COPPER", -3, 0, new ItemStack(TWR_Items.itemWandCap,1,1), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_BRASS.1"))
                        .build()
        };
        parents = new String[] {"BASETHAUMATURGY","METALLURGY@2"};
        ResearchHelper.makeThaumaturgyResearch("CAP_BRASS", -2, -2, new ItemStack(TWR_Items.itemWandCap,1,2), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_SILVER.1"),TWR_Recipes.recipes.get("CAP_SILVER.2"))
                        .build()
        };
        parents = new String[] {"CAP_BRASS","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("CAP_SILVER", -4, -3, new ItemStack(TWR_Items.itemWandCap,1,4), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_THAUMIUM.1"),TWR_Recipes.recipes.get("CAP_THAUMIUM.2"))
                        .build()
        };
        parents = new String[] {"CAP_BRASS","METALLURGY@3","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("CAP_THAUMIUM", -2, -5, new ItemStack(TWR_Items.itemWandCap,1,6), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("CAP_VOID.1"),TWR_Recipes.recipes.get("CAP_VOID.2"))
                        .setWarp(2)
                        .build()
        };
        parents = new String[] {"CAP_THAUMIUM","BASEELDRITCH@2","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("CAP_VOID", -4, -6, new ItemStack(TWR_Items.itemWandCap,1,8), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_GREATWOOD.1"))
                        .build()
        };
        parents = new String[] {"BASETHAUMATURGY","!PLANTWOOD"};
        ResearchHelper.makeThaumaturgyResearch("ROD_GREATWOOD", 1, 2, new ItemStack(TWR_Items.itemWandRod,1,0), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_REED.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_REED", 3, 1, new ItemStack(TWR_Items.itemWandRod,1,1), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_BLAZE.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_BLAZE", 4, 1, new ItemStack(TWR_Items.itemWandRod,1,2), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_ICE.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_ICE", 5, 1, new ItemStack(TWR_Items.itemWandRod,1,3), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_OBSIDIAN.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_OBSIDIAN", 3, 3, new ItemStack(TWR_Items.itemWandRod,1,4), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_QUARTZ.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_QUARTZ", 4, 3, new ItemStack(TWR_Items.itemWandRod,1,5), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_BONE.1"))
                        .setWarp(2)
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_BONE", 5, 3, new ItemStack(TWR_Items.itemWandRod,1,6), stages, parents);
        ...
        stages = new ResearchStage[] {
                ...
                new ResearchHelper.RSB()
                        ...
                        .setRecipes(TWR_Recipes.recipes.get("ROD_SILVERWOOD.1"))
                        .build()
        };
        parents = new String[] {"ROD_GREATWOOD","INFUSION"};
        ResearchHelper.makeThaumaturgyResearch("ROD_SILVERWOOD", 7, 5, new ItemStack(TWR_Items.itemWandRod,1,7), stages, parents);

        TWR_Compat.initResearch();
    ...
    public static void postInit() {
        ...
        stages[2].setRecipes(new ResourceLocation[]{TWR_Recipes.recipes.get("FIRSTSTEPS.1")});
