...
import com.interplay.thaumicwandsremastered.asm.ThaumicWandsRemasteredCore;
import com.interplay.thaumicwandsremastered.container.ContainerArcaneWorkbenchNew;
...
public class GUIArcaneWorkbenchNew extends GuiContainer {
    ...
    public GUIArcaneWorkbenchNew(InventoryPlayer inventory, TileArcaneWorkbench e) {
        ...
        this.tex = new ResourceLocation(ThaumicWandsRemastered.MODID, "textures/gui/arcaneworkbench.png");
        this.tileEntity = e;
        this.ip = inventory;
        this.ySize = 234;
        this.xSize = 190;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int cost = 0;
        int discount = 0;
        IArcaneRecipe result = ThaumicWandsRemasteredCraftingManager.findMatchingArcaneRecipe(this.tileEntity.inventoryCraft, this.ip.player);
