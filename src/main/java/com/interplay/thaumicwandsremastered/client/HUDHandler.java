...
public class HUDHandler {
    ...
    public static void renderHUDHigh(TickEvent.RenderTickEvent e) {
            ...
            if(Minecraft.getMinecraft().getRenderViewEntity() instanceof EntityPlayer) {
                ...
                if(player != null && Minecraft.getMinecraft().inGameHasFocus && Minecraft.isGuiEnabled())
                    if(!WandHelper.getHeldWand(player).isEmpty()) {
                        ...
                        double max = ((ItemWand) TWR_Items.itemWand).getMaxCharge(WandHelper.getHeldWand(player), player);
    ...
    public static void renderHUDLow(TickEvent.RenderTickEvent e) {
        if(e.phase != TickEvent.Phase.START)
            if(Minecraft.getMinecraft().getRenderViewEntity() instanceof EntityPlayer) {
                EntityPlayer player = (EntityPlayer) Minecraft.getMinecraft().getRenderViewEntity();
                if(player != null && Minecraft.getMinecraft().inGameHasFocus && Minecraft.isGuiEnabled())
